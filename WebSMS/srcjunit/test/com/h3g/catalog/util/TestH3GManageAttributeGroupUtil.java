/************************************************************************************
 * File Name    	: TestH3GManageAttributeGroupUtil.java
 *
 * Organization     : IBM
 *
 * Description      : This class is a junit test class for H3GManageAttributeGroupUtil.java
 * 					  
 * 
 * Modification Log  :
 * -------------------------------------------------------------------------
...
import com.h3g.catalog.util.H3GManageAttributeGroupUtil;
...
public class TestH3GManageAttributeGroupUtil {
	...
	/**
	 * This test case is used to test the createManageAttributeGroupXml method of H3GManageAttributeGroupUtil
	 * @throws Exception
	 */
	@Test
	public void testCreateManageAttributeGroupXml() throws Exception {
		...
		Document inDoc = SCXmlUtil.createFromFileOrUrl(
				"resources/com/h3g/catalog/util/testManageAttributeGroupUtil_createManageAttributeGroupXml_Input.xml");

		Document outDoc = SCXmlUtil.createFromFileOrUrl(
				"resources/com/h3g/catalog/util/testManageAttributeGroupUtil_createManageAttributeGroupXml_Output.xml");
		
		Document chgDoc = SCXmlUtil.createFromFileOrUrl(
				"resources/com/h3g/catalog/util/testManageAttributeGroupUtil_createManageAttributeGroupXml_CHG.xml");
		...
		YFCDocument docMultiApi = H3GManageAttributeGroupUtil.createManageAttributeGroupXml(inDoc, eResourceSpecification, environment);
